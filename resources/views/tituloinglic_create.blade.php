...
<div class="container-fluid">
    <h1 class="text-primary mt-3 mb-4 text-center"><b>Titulo Ing y Lic</b></h1>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6"><b>Titulo Ing y Lic</b></div>
                        <div class="col-md-6">
    ...
    <div class="card-body">
        <form action="{{ route('tituloinglic.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
