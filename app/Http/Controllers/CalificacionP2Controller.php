...
class CalificacionP2Controller extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('calificacion_create_parcial2', compact('ciclos', 'asignaturas', 'estudiantes', 'estudiante', 'idCiclo', 'idAsignatura', 'cicloSeleccionado', 'asignaturaSeleccionada'));
    }
    ...
    {
        $estudiantes_id = $request->input('estudiantes_id');
        $asignaturas_id = $request->input('asignaturas_id');
        $parcial2 = $request->input('parcial2');

        // Buscar la calificación existente
        $calificacion = Calificacion::where('estudiantes_id', $estudiantes_id)
                                    ->where('asignaturas_id', $asignaturas_id)
                                    ->first();
